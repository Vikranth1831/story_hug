...
class _ViewCardPartsState extends State<ViewCardParts> {
  ...
  //                           STORY CARD WIDGET
  // =====================================================================
  Widget _buildStoryCard(int index,var h,var w) {
    return GestureDetector(
      onTap: () {
        context.push('/nextPage'); // your next route
      },
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // ROW 2: Play Icon + Duration + Play Now Button
            Row(
