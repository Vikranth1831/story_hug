      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/bgimage.png"), // your background image
            fit: BoxFit.cover,
          ),
        ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Image.asset('assets/icons/backword.png',
                                height: isTablet ? 40 : 35,
                                color: Color(0xffF9E2A1)),

                            Icon(Icons.play_circle_fill_rounded,
                                size: isTablet ? 55 : 45,
                                color:Color(0xffF9E2A1)),

                            Image.asset('assets/icons/forword.png',
                                height: isTablet ? 40 : 35,
                                color: Color(0xffF9E2A1)),
                          ],
                        ),
                        ...
                        Slider(
                          ...
                          min: 0,
                          max: 162,
                          thumbColor: Color(0xffF9E2A1),
                          activeColor: Color(0xffF9E2A1),
                          onChanged: (v) {},
                        ),
